 ...
 * @author Arthur
 */
public class SnowFogWeather extends AbstractWeather {
    ...
    public SnowFogWeather() {
        Tmap.getRay().setAmbientLight(weatherColor);
        ParticleManager.addParticleFixed("particle/snow.p", -20, Gdx.graphics.getHeight(), 0.5f);
//        ParticleManager.addParticleFixed("particle/snow.p", Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), 0.5f);
    }
