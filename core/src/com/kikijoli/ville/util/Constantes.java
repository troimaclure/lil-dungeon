...
public class Constantes {
    ...
    public final static String ROLLING_TRAP = "d";
    public static String NPC_MOVEMENT_OK = ROLLING_TRAP + GUARD_WITH_KEY + Constantes.MAGICIAN + Constantes.ARCHER + Constantes.TRAP + Constantes.KEY + Constantes.EMPTY + Constantes.GUARD + Constantes.PLAYER;
